...
export const AbacusColumn = memo(({
  ...
  return (
    <div className="flex flex-col items-center relative" style={{ minWidth: beadSize * 1.8, padding: '0 1px' }}>
      ...
      {/* Column label */}
      {showLabel && (
        <div className="text-center mb-0.5 z-20" style={{ minHeight: 18, marginTop: -52 }}>
          <div 
      ...
      {/* === UPPER DECK — 1 bead === */}
      <div className="relative z-10" style={{ height: beadHeight * 0.8 }}>
        <div style={{ marginTop: -beadHeight * 0.9 }}>
          <AbacusBead
            isUpper={true}
